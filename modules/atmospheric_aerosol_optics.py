...
from modules.physics import calculate_physical_properties, calculate_brown_carbon_properties
import os 
import sys
...
def calculate_optical_properties4brc(hamb, tids, wvln, **kwargs):
    ...
    phys = calculate_brown_carbon_properties()
         
    with nc.Dataset('../scpy_apprch/nkxrnel.nc', 'r') as inp:
        ngrd = inp.variables['NGRD'][:]
        kgrd = inp.variables['KGRD'][:]
        xvnb = inp.variables['XVNB'][:]
        qext = inp.variables['QEXT'][:,:,:]
